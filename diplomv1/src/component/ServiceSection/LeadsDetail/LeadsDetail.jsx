...
const servicesData = {
  ...
  webanalytics: {
    ...
    printProducts:{
        ...
        description:
        "Производство листовок, буклетов, каталогов и другой рекламной полиграфии для бизнеса",
        items: ["Технический аудит", "Контент-маркетинг", "Линкбилдинг"],
        highlights: [
            "Листовки",
            "Буклеты",
    ...
    description:
    "Изготовление брендированных сувениров для продвижения вашей компании и подарков клиентам.",
    items: ["Флешки с логотипом", "Кружки", "Блокноты", "Брендированные ручки"],
    highlights: [
        "Флешки с логотипом",
        "Кружки",
        "Блокноты",
    ...
    corporateProducts: {
        ...
        description:
        "Полный цикл разработки и печати корпоративных материалов: от визиток до брендированных пакетов.",
        items: ["Визитки", "Фирменные бланки", "Конверты", "Папки"],
        highlights: [
            "Визитки",
            "Фирменные бланки",
            "Конверты",
    ...
    packagingLabels: {
        category: "Упаковка и этикетки",
            ...
            description:
            "Разработка и печать упаковки, стикеров и этикеток для продукции любой категории.",
            items: ["Коробки", "Стикеры", "Этикетки", "Бирки"],
            highlights: [
                "Коробки",
                "Стикеры",
                "Этикетки",
    ...
    calendars: {
        ...
        title: "Календари",
        description:
        "Печать настольных, настенных и перекидных календарей для корпоративного и рекламного использования.",
        items: ["Настольные календари", "Настенные календари", "Перекидные календари", "Карманные календари"],
        highlights: [
    ...
    posMaterials: {
            category: "POS-материалы",
            title: "POS-материалы",
            description:
            "Изготовление рекламных материалов для мест продаж: воблеры, шелфтокеры, дисплеи.",
            items: ["Воблеры", "Шелфтокеры", "Дисплеи", "Стойки"],
            highlights: [
                "Воблеры",
                "Шелфтокеры",
                "Дисплеи",
